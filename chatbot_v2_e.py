...
#     "score_threshold": 0.6,  # FAISS 유사도 하한선 적용
#     "k": 15                  # recall 향상
# })
...
llm = ChatOpenAI(model_name="gpt-4o")  # 또는 gpt-3.5-turbo
multi_query_retriever = MultiQueryRetriever.from_llm(
    retriever=base_vector_retriever,
    llm=llm
)
# # --------------------- 4-2. MultiQueryRetriever 설정 ---------------------
# from langchain.prompts import PromptTemplate

# multi_query_prompt = PromptTemplate.from_template("""
# 당신은 CBAM 전문가입니다.
# 아래 질문의 의미가 유지되도록, 표현만 다르게 바꾼 질문 3가지를 작성하세요.
# - 질문의 의도를 왜곡하지 말고, 같은 정보 요청 목적을 유지하세요.
